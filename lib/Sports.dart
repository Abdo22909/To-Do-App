        ...
        floatingActionButton: Column(mainAxisSize: MainAxisSize.min,children: [
          ...
          ScaleTransition(scale: CurvedAnimation(
              ...
              child: FloatingActionButton(backgroundColor: Colors.blue,heroTag: 'add',mini: true,onPressed: (){
                Share.share("Today ${_ScreenState}, ${_doneState}/${_sportsState}");
...
class _ScreenState extends State<Screen> {
  ...
  void initState() {
    super.initState();
    PathProvider12.readData().then((data1) {
      setState(() {
        ...
        children: <Widget>[
          Container(
            ...
            child: Row(
              children: <Widget>[
                Expanded(child:
                FlatButton(onPressed: (){Navigator.pushNamed(context,'newTask4');}, child:Text('New Task') ))
              ],
            ),
          ),
          TaskList1(_myList1),
                            ...
                            action: SnackBarAction(
                              ...
                              onPressed: (){
                                setState(() {
                                  ...
                                  PathProvider12.saveData(_myList1);
                                });
                              },
                            ),
...
class newTask4 extends StatefulWidget {
  @override
  _newTask4State createState() => _newTask4State();
}

class _newTask4State extends State<newTask4> {
  List _myList = [];
  ...
  void _addTask() {
    if (_textfieldcontroller.text != "" && _textfield.text != "" && _textfieldcontroller1.text != ""&&_image!=null) {
      setState(() {
        ...
        PathProvider12.saveData(_myList);
      });
    }
  }
  File _image;
