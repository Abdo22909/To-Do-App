...
class _ScreenState extends State<Screen> {
  ...
  void initState() {
    super.initState();
    PathProvider2.readData().then((data1) {
      setState(() {
        ...
        children: <Widget>[
          Container(
            ...
            child: Row(
              children: <Widget>[
                Expanded(child:
                FlatButton(onPressed: (){Navigator.pushNamed(context,'newTask1');}, child:Text('New Task') ))
              ],
            ),
          ),
          TaskList1(_myList1),
                    ...
                    IconSlideAction(
                      ...
                      onTap: (){
                        setState(() {
                          ...
                          PathProvider2.saveData(_myList1);
...
class PathProvider2{
  ...
  static Future<File> saveData(list1) async {
    String data2 = json.encode(list1);
    final file1 = await getFile();
    return file1.writeAsString(data2);
  }
...
class newTask1 extends StatefulWidget {
  @override
  _newTask1State createState() => _newTask1State();
}
  ...
  void _addTask() {
    if (_textfieldcontroller.text != "" && _textfield.text != "" && _textfieldcontroller1.text != ""&&_image!=null) {
      setState(() {
        ...
        PathProvider2.saveData(_myList);
      });
    }
  }
  File _image;
