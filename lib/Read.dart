...
class _ScreenState extends State<Screen> {
  ...
  void initState() {
    super.initState();
    PathProvider1.readData().then((data1) {
      setState(() {
        ...
        children: <Widget>[
          Container(
            ...
            child: Row(
              children: <Widget>[
                Expanded(child:
            FlatButton(onPressed: (){Navigator.pushNamed(context,'newTask');}, child:Text('New Task') ))
              ],
            ),
          ),
          TaskList1(_myList1),
                    ...
                    IconSlideAction(
                      ...
                      onTap: (){
                        setState(() {
                          ...
                          PathProvider1.saveData(_myList1);
...
class PathProvider1{
  ...
  static Future<File> saveData(list1) async {
    String data1 = json.encode(list1);
  ...
  void _addTask() {
    if (_textfieldcontroller.text != "" && _textfield.text != "" && _textfieldcontroller1.text != ""&&_image!=null) {
      setState(() {
        ...
        PathProvider1.saveData(_myList);
      });
    }
  }
  File _image;
