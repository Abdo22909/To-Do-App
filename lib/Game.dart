...
class _ScreenState extends State<Screen> {
  ...
  void initState() {
    super.initState();
    PathProvider3.readData().then((data1) {
      setState(() {
        ...
        children: <Widget>[
          Container(
            ...
            child: Row(
              children: <Widget>[
                Expanded(child:
                FlatButton(onPressed: (){Navigator.pushNamed(context,'newTask2');}, child:Text('New Task') ))
              ],
            ),
          ),
          TaskList1(_myList1),
                            ...
                            action: SnackBarAction(
                              ...
                              onPressed: (){
                                setState(() {
                                  ...
                                  PathProvider3.saveData(_myList1);
                                });
                              },
                            ),
...
class PathProvider3{
  ...
  static Future<File> saveData(list1) async {
    String data3 = json.encode(list1);
    final file1 = await getFile();
    return file1.writeAsString(data3);
  }
...
class newTask2 extends StatefulWidget {
  @override
  _newTask2State createState() => _newTask2State();
}

class _newTask2State extends State<newTask2> {
  List _myList = [];
  ...
  void _addTask() {
    if (_textfieldcontroller.text != "" && _textfield.text != "" && _textfieldcontroller1.text != ""&&_image!=null) {
      setState(() {
        ...
        PathProvider3.saveData(_myList);
      });
    }
  }
  File _image;
    ...
    return Container(
      child: SingleChildScrollView(
        child: Column(children: [
          Container(child:Lottie.asset('asset/lottie/42027-2021.json')),
